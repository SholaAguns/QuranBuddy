...
{
    public class When_Calling_GetVersesByChapterNameAsync
    {
        ...
        public When_Calling_GetVersesByChapterNameAsync()
        {
        ...
        public async Task Then_3_Verses_Should_Be_Returned()
        {
            ...
            var result = await verseService.GetVersesByChapterNameAsync(testChapter.Name);
